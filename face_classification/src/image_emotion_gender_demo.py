...
gender_model_path = (
    "face_classification/trained_models/gender_models/simple_CNN.81-0.96.hdf5"
)
...
cv2.imwrite("face_classification/images/predicted_test_image.png", bgr_image)
