...
class DataManager(object):
    ...
    def __init__(self, dataset_name="imdb", dataset_path=None, image_size=(48, 48)):
        ...
        if self.dataset_path is not None:
            ...
            self.dataset_path = "face_classification/datasets/fer2013/fer2013.csv"
    ...
    def _load_fer2013(self):  # get face pixels and emotions as features 40x40
        ...
        # emotions = pd.get_dummies(data["emotion"]).as_matrix()  #depricated
...
def split_data(x, y, validation_split=0.2):  # dataset split
    num_samples = len(x)
